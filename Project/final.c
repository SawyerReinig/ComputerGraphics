...
void display()
{
   ...
   // glUseProgram(shader[1]); //use the shaders to moved the vertices of the model
   ...
   // Vector3 Vector3Zero; Vector3Zero.x = 0; Vector3Zero.y = 0; Vector3Zero.z = 0; 
   // drawCubeAt(Vector3Zero,Vector3Zero); 
...
void key(unsigned char ch,int x,int y)
{
   ...
   //  Switch display mode
      ...
      motionData = readMotionCaptureData("MoCapData/TwistDance60fps.csv", &frameCount); frameRateDelay = 20; 
   }
   else if(ch == '6'){
